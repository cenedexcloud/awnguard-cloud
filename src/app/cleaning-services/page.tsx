      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Professional cleaning solutions for commercial and residential properties across Southern California
          </p>
          <a href="/quote" className="inline-block bg-primary text-white px-12 py-4 rounded-full text-lg font-semibold hover:bg-primary/90 transition-colors shadow-lg">
            Request a Quote
          </a>
        </div>
      </section>
