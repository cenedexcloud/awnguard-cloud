      ...
      <div className="bg-[#81a9c2] text-white h-[550px] flex items-center overflow-hidden">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center w-full h-full">
          ...
          <div className="p-8 md:p-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 uppercase tracking-wide whitespace-nowrap">
              AwnGuard Leading the Urban Oasis Movement
            </h2>
            <p className="text-base leading-relaxed mb-6 italic whitespace-nowrap" style={{ color: '#000000' }}>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="border-b border-[#FAFAFA]">
                ...
                >
                  <span className="text-sm uppercase tracking-widest" style={{ color: '#000000', fontFamily: 'Prompt', fontWeight: '200' }}>
                    Startup Story
                  </span>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            >
              <span className="text-sm uppercase tracking-widest text-gray-700" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>
                Childhood Inspiration
              </span>
      ...
      <div id="faq" className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            ...
            <span className="text-[#ab772b]">FAQS</span>
          </h2>
          <div className="w-full h-1 bg-[#ab772b] mb-12"></div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="border-b border-[#FAFAFA] pb-4">
                  ...
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>What is your Vision?</span>
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>What is your mission?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'mission' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>What are your hours?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'hours' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>Do you only work with commercial clients?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'commercial' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>What are recurring services?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'recurring' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>How often should I clean my awnings?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'how-often' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>How does AwnGuard clean awnings?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'how-clean' && (
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>What causes mold on awnings?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'mold' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>What are the consequences of improper maintenance?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
              ...
              <div className="space-y-4">
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>Do you help with awning recovers?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'recovers' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>What is the best awning color to pick?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'color' && (
                    <div className="mt-3 text-sm text-gray-700 leading-relaxed space-y-2">
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>What fabric is the right fabric?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'fabric' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
                ...
                <div className="border-b border-[#FAFAFA] pb-4">
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left"
                  >
                    <span className="text-gray-900 text-sm uppercase" style={{ fontFamily: 'Prompt', fontWeight: '200' }}>Do you make custom awnings?</span>
                    <span className="text-2xl text-gray-600">+</span>
                  </button>
                  {openFAQ === 'custom' && (
                    <p className="mt-3 text-sm text-gray-700 leading-relaxed">
